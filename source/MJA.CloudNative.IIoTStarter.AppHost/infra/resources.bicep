...
resource timescaleBm0FileShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
  parent: storageVolumeFileService
  name: take('${toLower('timescale')}-${toLower('bm0')}', 60)
  properties: {
    shareQuota: 1024
...
resource timescaleBm0Store 'Microsoft.App/managedEnvironments/storages@2023-05-01' = {
  parent: containerAppEnvironment
  name: take('${toLower('timescale')}-${toLower('bm0')}', 32)
  properties: {
    azureFile: {
      shareName: timescaleBm0FileShare.name
...
output SERVICE_TIMESCALE_VOLUME_BM0_NAME string = timescaleBm0Store.name
output SERVICE_TIMESCALE_FILE_SHARE_BM0_NAME string = timescaleBm0FileShare.name
